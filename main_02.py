...
parser.add_argument('--bs',           default=24,   type=int,   help='Mini-Batchsize size per GPU.')
...
parser.add_argument('--evaluate', action='store_true', default=True,   help='Evaluation only using 25 clips per video')
